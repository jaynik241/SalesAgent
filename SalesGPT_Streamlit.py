...
os.environ['OPENAI_API_KEY'] = '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'
...
if st.button("Submit"):
    if user_input:
        ...
        ai_response_placeholder.text_area("Sales Agent:", value=ai_response, height=150)