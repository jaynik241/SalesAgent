...
class MyBaseModel(BaseModel, metaclass=CustomMetaclass):
    pass

class MyBaseChain(Chain, metaclass=CustomMetaclass):
    pass

class StageAnalyzerChain(LLMChain, MyBaseChain):
...
class SalesConversationChain(LLMChain, MyBaseChain):
...
class SalesGPT(MyBaseChain, MyBaseModel):
